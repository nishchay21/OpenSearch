...
public class StoredFieldsPrefetch implements SearchOperationListener {
    ...
    private void executePrefetch(SearchContext context) {
        ...
        for (int index = 0; index < context.docIdsToLoadSize(); index++) {
            ...
            try {
                ...
                log.debug("Prefetching stored fields for index shard: " + context.indexShard().shardId() +
                    ", docId: " + docId + " readerIndex: " + readerIndex);
    ...
    private int findRootDocumentIfNested(SearchContext context, LeafReaderContext subReaderContext, int subDocId)
        throws IOException {
