...
public class CachedSwitchableIndexInput implements CachedIndexInput {
    ...
    public CachedSwitchableIndexInput(
        ...
        switchableIndexInput = new SwitchableIndexInput(resourceDescription, fileName, getFilePath(localDirectory, fileName), getFilePathSwitchable(localDirectory, fileName), fileCache, localDirectory, remoteDirectory, transferManager, cacheFromRemote, threadPool, tieredStoragePrefetchSettingsSupplier);
    }
