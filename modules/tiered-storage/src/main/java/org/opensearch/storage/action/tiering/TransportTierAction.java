...
public class TransportTierAction extends TransportClusterManagerNodeAction<IndexTieringRequest, AcknowledgedResponse> {
    ...
    public TransportTierAction(
        ...
        super(migrationActionName, transportService, clusterService, threadPool, actionFilters, IndexTieringRequest::new, indexNameExpressionResolver);
    ...
    protected void clusterManagerOperation(
        ...
        ActionListener<ClusterStateUpdateResponse> clusterStateUpdateListener = new ActionListener<>() {
            ...
            public void onFailure(Exception e) {
                logger.debug((Supplier<?>) () -> new ParameterizedMessage("failed to start tiering for index " +
                    "[{}]", request.getIndex()), e);
