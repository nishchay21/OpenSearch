...
public class TransportGetTieringStatusAction extends TransportClusterManagerNodeReadAction<GetTieringStatusRequest, GetTieringStatusResponse> {
    ...
    @Inject
    public TransportGetTieringStatusAction(TransportService transportService,
        ...
        super(GetTieringStatusAction.NAME, transportService, clusterService, threadPool, actionFilters,
                GetTieringStatusRequest::new, indexNameExpressionResolver);
    ...
    @Override
    public void clusterManagerOperation(GetTieringStatusRequest request, ClusterState clusterState,
        ...
        try {
            ...
            listener.onResponse(new GetTieringStatusResponse(migrationServiceMap.get(tieringState).getTieringStatus(request.getIndex(),request.getDetailedFlag())));
        } catch (Exception ex) {
    ...
    @Override
    public ClusterBlockException checkBlock(GetTieringStatusRequest request, ClusterState clusterState) {
