 ...
 */
public class TransportCancelTierActionTests extends OpenSearchTestCase {
    ...
    public void testRequestModelValidation() {
        ...
        assertEquals("Request should contain correct index", 
            "test-index", validRequest.getIndex());
