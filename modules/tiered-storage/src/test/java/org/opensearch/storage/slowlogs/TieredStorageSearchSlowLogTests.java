...
public class TieredStorageSearchSlowLogTests extends OpenSearchTestCase {
    ...
    public void testSlowLogSettingsMap() {
        ...
        assertTrue(TieredStorageSearchSlowLog.TIERED_STORAGE_SEARCH_SLOWLOG_SETTINGS_MAP.containsKey(
    ...
    public void testTieredStorageSlowLogPrinterConstructor() {
        TieredStorageSearchSlowLog.TieredStorageSlowLogPrinter printer =
            new TieredStorageSearchSlowLog.TieredStorageSlowLogPrinter(
                searchContext,
    ...
    public void testSettingsPrefix() {
        ...
        assertTrue(TieredStorageSearchSlowLog.TIERED_STORAGE_SEARCH_SLOWLOG_ENABLED.getKey()
            .startsWith(expectedPrefix));
        assertTrue(TieredStorageSearchSlowLog.INDEX_SEARCH_SLOWLOG_THRESHOLD_QUERY_WARN_SETTING.getKey()
            .startsWith(expectedPrefix));
        assertTrue(TieredStorageSearchSlowLog.INDEX_SEARCH_SLOWLOG_LEVEL.getKey()
            .startsWith(expectedPrefix));
    }
