...
public class TestOnDemandPrefetchBlockSnapshotIndexInput extends OnDemandPrefetchBlockSnapshotIndexInput {
    ...
    public TestOnDemandPrefetchBlockSnapshotIndexInput(Builder<?> builder, String resourceDescription, BlobStoreIndexShardSnapshot.FileInfo fileInfo, FSDirectory directory, TransferManager transferManager, ThreadPool threadPool, FileCache fileCache, Supplier<TieredStoragePrefetchSettings> tieredStoragePrefetchSettingsSupplier) {
        super(builder, resourceDescription , fileInfo, directory, transferManager, threadPool, fileCache, tieredStoragePrefetchSettingsSupplier);
    }
    ...
    // Expose new cache tracking methods for testing
    @Override
