...
public class RestCancelTierActionTests extends OpenSearchTestCase {
    ...
    public void testInvalidInputNullIndex() {
        final RestRequest requestWithNullIndex = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/")
            .build();
    ...
    public void testInvalidInputMultipleIndices() {
        final RestRequest requestWithMultipleIndices = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/foo,bar")
    ...
    public void testValidSingleIndex() {
        final RestRequest validRequest = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/test-index")
    ...
    public void testValidIndexWithTimeoutParameters() {
        final RestRequest requestWithTimeouts = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/test-index")
            .withParams(Map.of(
                "index", "test-index",
                "timeout", "30s",
    ...
    public void testValidDataStreamBackingIndex() {
        ...
        final RestRequest validDataStreamRequest = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/.ds-logs-2023.01.01-000001")
            .withParams(Map.of("index", ".ds-logs-2023.01.01-000001"))
            .build();
    ...
    public void testInvalidBlankIndexName() {
        final RestRequest requestWithBlankIndex = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/ /")
            .withParams(Map.of("index", " "))
            .build();
    ...
    public void testValidIndexWithSpecialCharacters() {
        ...
        final RestRequest validSpecialCharRequest = new FakeRestRequest.Builder(xContentRegistry())
            .withPath("/_tier/_cancel/test-index_123")
            .withParams(Map.of("index", "test-index_123"))
            .build();
