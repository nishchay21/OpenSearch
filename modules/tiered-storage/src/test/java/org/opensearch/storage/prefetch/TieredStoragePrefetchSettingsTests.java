...
public class TieredStoragePrefetchSettingsTests extends OpenSearchTestCase {
    ...
    public void testUpdateAfterGetDefaultSettings() {
        TieredStoragePrefetchSettings tieringServicePrefetchSettings = new TieredStoragePrefetchSettings(clusterService.getClusterSettings());
        ...
        Settings settings = Settings.builder()
            .put(TieredStoragePrefetchSettings.READ_AHEAD_BLOCK_COUNT.getKey(), 10)
            .build();
