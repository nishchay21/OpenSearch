...
public class DataFormatAwareReadOnlyEngine implements Indexer {
    ...
    public DataFormatAwareReadOnlyEngine(EngineConfig engineConfig) {
        ...
        try {
            ...
            // Files listeners make IndexFileDeleter fire onFilesAdded for the committed snapshot at
            // open, eagerly warming the metadata cache before the first query; snapshot listeners
            // build the reader before latestCatalogSnapshot is swapped.
