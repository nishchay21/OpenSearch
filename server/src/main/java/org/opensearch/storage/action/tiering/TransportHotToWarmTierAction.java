        ...
        clusterService.submitStateUpdateTask(
            ...
            new ClusterStateUpdateTask(Priority.URGENT) {
                ...
                public ClusterState execute(ClusterState currentState) {
                    ...
                    // Add both read_only_allow_delete and write blocks.
                    // - read_only_allow_delete: prevents new writes and is used as a preparation gate
                    //   before the remote store sync (flush + refresh).
                    // - write (blocks.write): a hard write block that survives even if
                    //   DiskThresholdMonitor auto-removes the read_only_allow_delete block.
                    // Both are set in metadata (persisted, survives restart) AND in ClusterBlocks
                    // (enforced immediately at the transport layer on every write request).
